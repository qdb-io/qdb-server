...
public interface MessageFilter {
    ...
    /**
     * This method is called before the first call to {@link #accept(long, long, String, byte[])}.
     */
     ...
     * been read.
     */
    Result accept(long id, long timestamp, String routingKey, byte[] payload);
    ...
    public static final MessageFilter NULL = new MessageFilter() {
        ...
        public Result accept(long id, long timestamp, String routingKey, byte[] payload) { return Result.ACCEPT; }
    };
}
